...
class MenuPrincipal(ui.View):
    ...
    @ui.button(label="📁 Menu de Conteúdo", style=discord.ButtonStyle.success)
...
async def mostrar_menu_principal(channel):
    ...
    try:
        ...
        embed.add_field(name="📁 Menu de Conteúdo", value="Ver e gerenciar tudo", inline=False)
